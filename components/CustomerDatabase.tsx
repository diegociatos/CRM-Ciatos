    ...
    <div className="space-y-10 animate-in slide-in-from-right-10 duration-500">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-4">
           <button 
             onClick={() => {
               if(confirm("Deseja realmente excluir este cliente da base permanentemente?")) {
                 onDeleteCustomer(selectedCustomer.id);
                 setSelectedCustomerId(null);
               }
             }}
             className="px-6 py-3 bg-red-50 text-red-600 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-red-100 transition-all"
           >
             🗑️ Excluir Cliente
           </button>
